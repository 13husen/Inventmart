...
/**********************************************/
//   BRAND DTO(DATA TRANSFER OBJECT) untuk kebutuhan get data dan set penyimpanan ke table
/**********************************************/

public class BrandTableDTO extends RecursiveTreeObject<BrandTableDTO> {
	
        // asign global variable untuk binding dengan model input
	...
	private Brand originalBrand;
        ...
        // getter dan setter global variable
	...
	public void setAdditionalInformation(String additionalInformation) {
        ...
        // getter setter untuk satu object model brand
